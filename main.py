...
superstore_csv_url = ("https://raw.githubusercontent.com/mzeeshanaltaf/superstore-dashboard/main/Sample%20-%20Superstore.csv")
...
st.write(":blue[***Exploratory Data Analysis of Sample SuperStore Sales Data.***]")
st.markdown(''' Data Source: [Link](https://community.tableau.com/s/question/0D54T00000CWeX8SAL/sample-superstore-sales-excelxls)
    ''')
df = pd.read_csv(superstore_csv_url, encoding="utf-8")

col1, col2 = st.columns(2)
df["Order Date"] = pd.to_datetime(df["Order Date"])

# Getting the mix and max date
